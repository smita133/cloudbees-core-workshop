...
10. Next, open the GitHub editor for the **nodejs-pod.yaml** Pipeline script in the **master** branch of your forked **helloworld-nodejs** repository. Update `image` for the **nodejs** `container` to be `node:10.10.0-alpine`.
...
You may proceed to the next lab [*Lab 6. CloudBees Pipeline Template Catalogs*](./catalog-templates.md) or head back to the main list of the [**labs**](./README.md#workshop-labs) when you are ready.
