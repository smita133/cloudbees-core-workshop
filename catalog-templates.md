...
4. Fill out the template parameters:
   ...
   4. Leave GCP Project as is. <p><img src="img/catalog/template_parameters.png" width=800/>
...
8. You may need to refresh the Multibranch job screen, but eventually you should have one job for the **development** branch <p><img src="img/catalog/two_jobs.png" width=800/>
