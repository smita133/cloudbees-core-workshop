...
8. You may need to refresh the Multibranch job screen, but eventually you should have one job for the **development** branch <p><img src="img/catalog/one_job.png" width=800/>
