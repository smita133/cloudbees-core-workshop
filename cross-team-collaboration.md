...
You may proceed to the next lab [*Lab 7. CloudBees Pipeline Template Catalogs*](./catalog-templates.md) or head back to the main list of the [**labs**](./README.md#workshop-labs) when you are ready.
