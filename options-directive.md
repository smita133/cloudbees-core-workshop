...
You may proceed to the next lab [*Conditional Execution using the `when` directive *](./conditional-when.md) or head back to the main list of the [**labs**](./README.md#workshop-labs) when you are ready.
