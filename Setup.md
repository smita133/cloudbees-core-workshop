...
Today's URL for the CloudBees Core environment is https://cb-workshops.com/cjoc/
...
6. **Select team master creation recipe** - click on the drop-down to see the options, but select the top option: **Basic** recipe;<p><img src="img/setup/setup-create-team-recipe-2.png" width=450/>
